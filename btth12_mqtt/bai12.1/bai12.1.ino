...
const char* mqtt_user = "hung";           // <--- CHANGE ME
const char* mqtt_pass = "1234";              // <--- CHANGE ME

const char* student_id = "10123152";           // <--- CHANGE ME (Mã SV)
const char* mqtt_topic = "iot/lab1/10123152/sensor"; // <--- CHANGE ME (Phải khớp với student_id)
/* ================================================ */
