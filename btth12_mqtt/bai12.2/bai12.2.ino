...
// ========== CẤU HÌNH WIFI ==========
const char* ssid = "Hùnn";      // Thay bằng tên WiFi thật
const char* password = "11223322";     // Thay bằng mật khẩu WiFi thật

// ========== CẤU HÌNH MQTT ==========
const char* mqtt_server = "172.20.10.2";  // Thay bằng IP của HA
const int mqtt_port = 1883;

// Thông tin đăng nhập MQTT (phải trùng với cấu hình trong Mosquitto)
const char* mqtt_user = "hung";        // Username MQTT
const char* mqtt_pass = "1234";        // Password MQTT

// Mã sinh viên
const char* student_id = "10123152";            // Thay bằng mã sinh viên thật
